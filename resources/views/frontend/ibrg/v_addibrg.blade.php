...
@section('title','Add Data Barang')
@section('content')

<form action="/ibrg/insert" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-sm"> Tambah Data Barang</button>
                </div>
